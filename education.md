      ...
      <div class="edu-grid">
        <article class="edu-card">
          ...
          <ul>
            ...
            <li>Alumnus of the Summer School in AI and Machine Learning for Medicine (CCAIM) and the Summer School in AI for Healthcare (AIxIA).</li>
        ...
        <article class="edu-card">
          ...
          <p class="edu-meta">Supervisor: Prof Fabio Ciceri. Co-Supervisor: Dr Attilio Bondanza.</p>
          <ul>
